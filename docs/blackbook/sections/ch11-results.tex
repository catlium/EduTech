...
\begin{center}
\textit{This chapter maps the delivered capabilities against the stated
objectives, summarises the validation evidence, discusses the key
architectural decisions, and records the accepted limitations of the
implementation.}
\end{center}
