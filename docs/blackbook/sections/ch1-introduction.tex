...
\begin{center}
\textit{This chapter introduces the project: the background and motivation
of the platform, the problem context, the objectives of the implementation,
the scope of the work, and the organisation of the report.}
\end{center}
