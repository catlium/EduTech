...
\begin{center}
\textit{This chapter analyses the existing college workflow, derives the
functional and non-functional requirements of the platform, defines the user
roles, and records the constraints, assumptions, and environment of use.}
\end{center}
