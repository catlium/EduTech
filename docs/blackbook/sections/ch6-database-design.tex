...
\noindent Figure~\ref{fig:erd-academic-content},
Figure~\ref{fig:erd-content-versions}, and Figure~\ref{fig:erd-syllabus} show
the academic and content families. Properties:
...
\label{fig:erd-practice-sessions}
\end{figure}
