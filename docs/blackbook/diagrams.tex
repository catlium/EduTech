...
\setcounter{chapter}{4}\setcounter{figure}{0}
...
\end{sidewaysfigure}
\setcounter{chapter}{5}\setcounter{figure}{0}
...
\end{figure}
\setcounter{chapter}{6}\setcounter{figure}{0}
...
\begin{sidewaysfigure}[p]
\centering
\includegraphics[width=404.9pt]{figures/erd-syllabus-colour.pdf}
...
\begin{figure}[p]
\centering
\includegraphics[width=297.7pt]{figures/erd-practice-sessions-colour.pdf}
...
\end{sidewaysfigure}
\setcounter{chapter}{7}\setcounter{figure}{0}
...
\end{sidewaysfigure}
\setcounter{chapter}{8}\setcounter{figure}{0}
