...
export const jobs = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('jobs_active_generation_unique')
      ...
      .where(
        sql`type IN ('AI_GENERATE_NOTE', 'AI_GENERATE_SUMMARY', 'AI_GENERATE_FLASHCARDS', 'AI_GENERATE_CONCEPTS', 'AI_GENERATE_CONTENT_PACKAGE', 'AI_GENERATE_SYLLABUS', 'AI_GENERATE_QUESTIONS', 'AI_GENERATE_BLUEPRINT', 'AI_GENERATE_STARTER_MATERIAL') AND status IN ('queued', 'processing')`,
      ),
  ],
);
