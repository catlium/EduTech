...
export { platformAuditEvents } from './schema/platform-audit.js';
...
export { subjects, chapters, topics, academicYears, classes, classSubjects, divisions, teacherAssignments, studentPlacements, studentSubjectEnrollments } from './schema/academic.js';
